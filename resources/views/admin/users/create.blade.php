      ...
      <div class="col-xl-4">
        ...
        <div class="card">
          <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
            ...
            <img src="{{ asset('uploads/users/add-user-vector-icon.jpg') }}" alt="Profile" class="rounded-circle">
            <h2>  </h2>
            <h3></h3>
            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade show active profile-overview" id="profile-overview">
                ...
                <div class="row mb-3">
                    ...
                    <img src="{{ asset('uploads/users/add-user-vector-icon.jpg') }}" alt="Profile" style="width: 70px;">
                    <div class="pt-2">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                    <input name="age" type="number" class="form-control" id="phone" min="18" max="40">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                    <input name="files" type="text" class="form-control" id="Linkedin" value="https://linkedin.com/#">
                    </div>
                </div>
