    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-calendar-date"></i><span>Đơn lịch</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#hoadon-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-calendar-date"></i><span>Hóa đơn</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="hoadon-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="charts-chartjs.html">
              <i class="bi bi-circle"></i><span>Chart.js</span>
            </a>
