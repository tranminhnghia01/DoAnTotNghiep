                    ...
                    <tbody>
                        {{-- @if (!empty($book)) --}}
                            ...
                            <tr>
                                ...
                                <td><a href="{{ route('admin.Appoin-ChamCong',$value->book_id) }}" class="btn btn-warning btn-chamcong" data-book_id="{{ $value->book_id}}" style="color: white;width: 170px;">Chấm công</a></td>
