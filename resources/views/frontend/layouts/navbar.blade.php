    ...
    <div class="row gx-0 d-none d-lg-flex">
        <div class="col-lg-7 px-5 text-start">
            <div class="h-100 d-inline-flex align-items-center py-3 me-4">
                ...
                <small>{{ $info->info_address }}</small>
            </div>
            <div class="h-100 d-inline-flex align-items-center py-3">
                <small class="far fa-clock text-orange me-2"></small>
                <small>Thứ 2 - Chủ nhật : 00.00 AM - 00.00 PM</small>
            </div>
        </div>
        <div class="col-lg-5 px-5 text-end">
            <div class="h-100 d-inline-flex align-items-center py-3 me-4">
                <small class="fa fa-phone-alt text-orange me-2"></small>
                <small>(+84) {{ $info->info_phone }}</small>
            </div>
            <div class="h-100 d-inline-flex align-items-center">
                <a class="btn btn-sm-square rounded-circle bg-white text-orange me-1"><i class="fab fa-facebook-f"></i></a>
                <a class="btn btn-sm-square rounded-circle bg-white text-orange me-1"><i class="fab fa-twitter"></i></a>
                <a class="btn btn-sm-square rounded-circle bg-white text-orange me-1"><i class="fab fa-linkedin-in"></i></a>
                <a class="btn btn-sm-square rounded-circle bg-white text-orange me-0"><i class="fab fa-instagram"></i></a>
            </div>
        </div>
    </div>
</div>
...
<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 wow fadeIn" data-wow-delay="0.1s">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        @if (Auth::check())
        <div class="nav-item dropdown">
            <a  class="btn btn-orange rounded-0 py-4 px-lg-5 d-none d-lg-block nav-link dropdown-toggle"  data-bs-toggle="dropdown">{{ Auth::user()->name }}<i class="fas fa-user" style="padding-left: 10px;"></i></a>
