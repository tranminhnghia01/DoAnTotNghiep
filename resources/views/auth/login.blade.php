              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Nhập email & mật khẩu của bạn để đăng nhập</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" novalidate action="{{ route('login') }}" method="POST">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="email" class="form-control @error('email') is-invalid @enderror" id="yourUsername" required value="{{ old('email') }}">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Bạn chưa có tài khoản? <a href="{{ route('register') }}">Tạo tài khoản</a></p>
                    </div>
                  </form>
